...
public partial class StorageVersionList
{
	/// <summary>
	...
	public System.Collections.Generic.List<StorageVersion> Items { get; set; } = new System.Collections.Generic.List<StorageVersion>();
