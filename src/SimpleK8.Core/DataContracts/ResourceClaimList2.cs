...
public partial class ResourceClaimList2
{
	/// <summary>
	...
	public System.Collections.Generic.List<ResourceClaim3> Items { get; set; } = new System.Collections.Generic.List<ResourceClaim3>();
