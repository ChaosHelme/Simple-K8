...
public partial class DeviceClassList2
{
	/// <summary>
	...
	public System.Collections.Generic.List<DeviceClass2> Items { get; set; } = new System.Collections.Generic.List<DeviceClass2>();
