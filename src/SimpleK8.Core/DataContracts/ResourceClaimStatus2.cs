...
public partial class ResourceClaimStatus2
{
	/// <summary>
	...
	public AllocationResult2 Allocation { get; set; }
	...
	public System.Collections.Generic.List<AllocatedDeviceStatus2> Devices { get; set; }
	...
	public System.Collections.Generic.List<ResourceClaimConsumerReference2> ReservedFor { get; set; }
