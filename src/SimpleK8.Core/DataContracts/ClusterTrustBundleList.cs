...
public partial class ClusterTrustBundleList
{
	/// <summary>
	...
	public System.Collections.Generic.List<ClusterTrustBundle> Items { get; set; } = new System.Collections.Generic.List<ClusterTrustBundle>();
