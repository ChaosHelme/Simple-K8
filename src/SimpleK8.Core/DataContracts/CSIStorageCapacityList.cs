...
public partial class CSIStorageCapacityList
{
	/// <summary>
	...
	public System.Collections.Generic.List<CSIStorageCapacity> Items { get; set; } = new System.Collections.Generic.List<CSIStorageCapacity>();
