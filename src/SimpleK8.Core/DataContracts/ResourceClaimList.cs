...
public partial class ResourceClaimList
{
	/// <summary>
	...
	public System.Collections.Generic.List<ResourceClaim2> Items { get; set; } = new System.Collections.Generic.List<ResourceClaim2>();
