...
public partial class LeaseCandidateList
{
	/// <summary>
	...
	public System.Collections.Generic.List<LeaseCandidate> Items { get; set; } = new System.Collections.Generic.List<LeaseCandidate>();
