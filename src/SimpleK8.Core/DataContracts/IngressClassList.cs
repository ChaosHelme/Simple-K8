...
public partial class IngressClassList
{
	/// <summary>
	...
	public System.Collections.Generic.List<IngressClass> Items { get; set; } = new System.Collections.Generic.List<IngressClass>();
