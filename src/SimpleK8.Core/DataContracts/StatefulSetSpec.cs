...
public partial class StatefulSetSpec
{
	...
	/// </summary>
	[Newtonsoft.Json.JsonProperty("ordinals", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
	public StatefulSetOrdinals Ordinals { get; set; }

	/// <summary>
	/// persistentVolumeClaimRetentionPolicy describes the lifecycle of persistent volume claims created from volumeClaimTemplates. By default, all persistent volume claims are created as needed and retained until manually deleted. This policy allows the lifecycle to be altered, for example by deleting persistent volume claims when their stateful set is deleted, or when their pod is scaled down.
	/// </summary>
	[Newtonsoft.Json.JsonProperty("persistentVolumeClaimRetentionPolicy", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
	...
	/// </summary>
	[Newtonsoft.Json.JsonProperty("podManagementPolicy", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
	...
	public System.Collections.Generic.List<PersistentVolumeClaim> VolumeClaimTemplates { get; set; }
