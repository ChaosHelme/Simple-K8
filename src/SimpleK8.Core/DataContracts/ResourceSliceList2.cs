...
public partial class ResourceSliceList2
{
	/// <summary>
	...
	public System.Collections.Generic.List<ResourceSlice2> Items { get; set; } = new System.Collections.Generic.List<ResourceSlice2>();
