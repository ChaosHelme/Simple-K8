...
public partial class ServiceCIDRList2
{
	/// <summary>
	...
	public System.Collections.Generic.List<ServiceCIDR2> Items { get; set; } = new System.Collections.Generic.List<ServiceCIDR2>();
