...
public partial class ServiceSpec
{
	...
	/// <br/>
	/// <br/>This field may hold a maximum of two entries (dual-stack IPs, in either order). These IPs must correspond to the values of the ipFamilies field. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field. More info: https://kubernetes.io/docs/concepts/services-networking/service/#virtual-ips-and-service-proxies
	/// </summary>
	...
	public System.Collections.Generic.List<string> ClusterIPs { get; set; }
	...
	public System.Collections.Generic.List<string> ExternalIPs { get; set; }
	...
	/// <br/>
	/// <br/>This field may hold a maximum of two entries (dual-stack families, in either order).  These families must correspond to the values of the clusterIPs field, if specified. Both clusterIPs and ipFamilies are governed by the ipFamilyPolicy field.
	/// </summary>
	...
	public System.Collections.Generic.List<string> IpFamilies { get; set; }
	...
	public System.Collections.Generic.List<string> LoadBalancerSourceRanges { get; set; }
	...
	public System.Collections.Generic.List<ServicePort> Ports { get; set; }
	...
	/// </summary>
	[Newtonsoft.Json.JsonProperty("trafficDistribution", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
