...
public partial class EndpointSliceList
{
	/// <summary>
	...
	public System.Collections.Generic.List<EndpointSlice> Items { get; set; } = new System.Collections.Generic.List<EndpointSlice>();
