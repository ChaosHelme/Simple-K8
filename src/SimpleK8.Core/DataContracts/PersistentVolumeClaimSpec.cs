...
public partial class PersistentVolumeClaimSpec
{
	...
	/// <br/>  specified.
	/// <br/>* While dataSource only allows local objects, dataSourceRef allows objects
	/// <br/>  in any namespaces.
	/// <br/>(Beta) Using this field requires the AnyVolumeDataSource feature gate to be enabled. (Alpha) Using the namespace field of dataSourceRef requires the CrossNamespaceVolumeDataSource feature gate to be enabled.
	/// </summary>
